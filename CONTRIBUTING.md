...
issue](https://github.com/cisagov/ansible-role-bloodhound/issues) in
...
```console
cd ansible-role-bloodhound
pyenv virtualenv <python_version_to_use> ansible-role-bloodhound
pyenv local ansible-role-bloodhound
